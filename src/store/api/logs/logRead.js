...
module.exports = ({ define }) => {
  define(
    'read',
    async ({ logType, lines = 100 }, { errors }) => {
      try {
        let logPath;
        ...
        switch (logType) {
          case 'CKPOOL':
            ...
            if (!logPath) {
              ...
              if (process.env.NODE_ENV !== 'production') {
                ...
                throw new Error('CKPOOL log file not found');
              }
            }
            break;
          case 'MINER':
          ...
          case 'NODE':
            ...
            break;
          default:
            throw new errors.ValidationError('Invalid log type');
        }
        ...
        // Instead of throwing, we'll return an error message as content
        // throw new errors.InternalError(`Failed to read log file: ${error.message}`);
      }
    },
    {
